...
const pillars = [
  {
    ...
    desc: "Government-approved subjects from Reception through Senior Secondary — rigorous, structured, and examination-ready.",
    color: "blue",
  },
  {
    icon: "⚙️",
    title: "Vocational Training",
    desc: "Hands-on skills: welding, fashion, ICT, catering, plumbing, painting and more — making graduates self-reliant.",
    color: "wine",
  },
  {
    icon: "🤝",
    title: "Certified Partnerships",
    desc: "We collaborate with the Federal Ministry of Labour, City & Guilds of London, and NBTE for recognised certifications.",
    color: "green",
  },
];
    ...
    <div className="home">
        ...
        <div className="hero-inner">
          <div className="hero-text">
            ...
            <p className="hero-desc">
              A forward-thinking school committed to eradicating illiteracy
              through quality education and practical skills development. We
              prepare students for higher education, employment, and
              self-reliance.
            </p>
      ...
      <section className="section">
        <div className="section-inner">
          ...
          <p className="section-sub">
            Two complete learning tracks. One extraordinary graduate.
          </p>
      ...
      <section className="gallery-strip">
        <div className="gs-inner">
          ...
          <div className="gs-text-card">
            ...
            <p>
              Well-equipped classrooms, technical workshops, computer labs, and
              practical skill areas — all designed for the modern learner.
            </p>
      ...
      <section className="section assess-section">
        <div className="section-inner assess-inner">
          <div className="assess-text">
            ...
            <p>
              We believe a child's success is determined by both academic
              performance and character development. Our grading system reflects
              the whole student — not just exam scores.
            </p>
            <button
              className="btn-blue"
              style={{ marginTop: 28 }}
      ...
      <section className="home-cta">
        <div className="hcta-inner">
          ...
          <p>
            Enrol your child today from Reception to Senior Secondary. Visit us
            at No. 1 Vision Drive, Okutukutu, Yenagoa.
          </p>
